...
## 9. 迭代计划 — 实际进度（更新于 2026-05-10）

| 阶段 | 内容 | 预估 | 实际 | 状态 |
|------|------|:----:|:----:|:----:|
| **Phase 0** | 项目初始化 + 基础配置 | 30 min | 30 min | ✅ 完成 |
| **Phase 1** | 布局框架 (Header, Footer, Theme) | 1h | 30 min | ✅ 完成 |
| **Phase 2** | 首页 Hero + Skills + Featured | 1.5h | 1.5h | ✅ 完成 |
| **Phase 3** | 关于 + 时间线 | 1h | 30 min | ✅ 完成 |
| **Phase 4** | 项目展示页 + 筛选 | 1.5h | 30 min | ✅ 完成 |
| **Phase 5** | 博客系统 (MDX) | 2h | — | ⬜ 待开始 |
| **Phase 6** | 联系表单 | 1h | — | ⬜ 待开始 |
| **Phase 7** | 动画 + 过渡效果 | 1h | — | 已在 Phase 2 提前完成 |
| **Phase 8** | SEO + 性能优化 | 1h | — | ⬜ 待开始 |
| **Phase 9** | 内容填充 + 部署 | 1h | — | ⬜ 待开始 |
| **总计** | | **~11h** | **~3h** | 剩余 ~6h |

> **说明**：
> - Phase 7（动画效果）已在 Phase 2 开发阶段提前完成（粒子、逐字弹入、3D tilt、数字递增、扫光效果、毛玻璃质感）。
> - 实际预计剩余工时约 6h（含博客系统开发）。
